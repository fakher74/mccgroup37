...
// gets details of event with parameter id
// TODO: check if authorized and if event with the id exists
...
function buildEditEventPage(id) {
...
$(document).ready(function(){
	...
	$(document).on('click', ".event-link", function(event) {
		buildEditEventPage(event.target.id);
	});
